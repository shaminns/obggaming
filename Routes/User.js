...
router.post(
	"/tournamentResult",
	videoUploadForTournament.single("videoResult"), TournamentController.addTournamentResult)
//Ladder
...
router.post(
	"/ladderResult",
	videoUpload.single("videoResult"), LadderController.addLadderResult)
//Total War Ladder
router.get("/totalWarLadder", LadderController.createAndGetTotalWarLadder)
router.post("/totalWarLadderResult", videoUploadForTWL.single("videoResult"), LadderController.submitTotalWarLadderResult)
//Games
router.get("/gameById", GameController.gameById)
router.get("/games", GameController.games)
//Match
router.post("/match", uploadMatch.single("matchTitleImage"), MatchController.createMatchInvitation)
...
router.post("/matchResult", uploadMatch.single("videoResult"), MatchController.addMatchResult)
router.get("/publicMatch", MatchController.publicMatches)
///////////////////////Franchise
router.post("/franchise", uploadFranchise.single("franchiseTitleImage"), FranchiseController.createFranchise)
router.patch("/franchise", FranchiseController.updateAboutAndStatus)
router.get("/allFranchise", FranchiseController.allFranchise)
router.get("/franchise", FranchiseController.getFranchiseByUserTokenOrFranchiseId)
///////////team
...
router.post("/franchiseTournamentResult", videoUploadForTournament.single("videoResult"), TournamentController.addFranchiseTournamentResult)
///////////game
...
router.post("/leagueResult", uploadLeagueResult.single("videoResult"), LeagueController.submitLeagueMatchResult)
///////////Fantasy League
////////user
...
router.get("/tradeMoveRequestDetail", FantasyLeagueController.tradeMoveRequestDetail)
router.patch("/tradeMoveRequest", FantasyLeagueController.updateTradeMoveRequestStatus)
//image
router.post(
	"/updateProfileImage",
...
router.post(
	...
	uploadBg.single("backgroundImage"), UserController.updateBackgroundImage)

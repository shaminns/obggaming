...
exports.allFranchise = async (req, res) => {
    ...
    if (userId != null) {
        if (!req.query.franchiseStatus) {
            franchiseData = await FranchiseHelper.showAllFranchiseWithoutDelete()
        }
        if (req.query.franchiseStatus) {
            if (req.query.franchiseStatus.toLowerCase() == "all") {
                franchiseData = await FranchiseHelper.showAllFranchiseWithoutDelete()
            } else {
                franchiseData = await FranchiseHelper.franchiseByStatus(req.query.franchiseStatus.toLowerCase())
            }
        }

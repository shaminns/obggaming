...
define("TEAM_SIZE_EXCEED", "Required Number of Teams Already Participating, Limit exceeded!!!")
define("TEAM_ALREADY_PARTICIPATING", "Team Already Participating")
define("TEAM_NOT_PARTICIPATING", "Team not Participating")
define("MEMBER_ALREADY_PARTICIPATED", "One of Your Team Member Already Participated from Other Team. Kindly Remove that Participant to Join")
...
define("TEAM_PARTICIPATE_IN_MATCH", "Not delete, Team participate in match / league")
...
define("ALREADY_WIN_TOURNAMENT_RESULT", "One Team Already Win This Tournament. Please Change Status of That Team to Win this Team,ONLY ONE WINNING TEAM REQUIRED")
define("LADDER_RESULT_RECORD_NOT_FOUND", "Ladder result record not found with this ID")
define("ALREADY_WIN_MATCH_RESULT", "One User Already Win This Match. Please Change Status of That User to Win this User,ONLY ONE WINNING USER REQUIRED")
define("MATCH_RESULT_RECORD_NOT_FOUND", "Match result record not found with this ID")
define("USER_INSUFFICIENT_CREDIT", "You do not have sufficient credit")
define("FRIEND_INSUFFICIENT_CREDIT", "The user you are inviting does not have sufficient credit")
define("ALREADY_HAVE_THIS_STATUS", "Someone already have this status (Win / Loss)")
define("NOT_BELONG_TO_FRANCHISE", "For only franchise users")
define("ONLY_FRANCHISE_OWNER_CAN_KICK_OUT", "Only franchise owner can kick out team member")
define("ONLY_FRANCHISE_OWNER_CAN_DELETE", "Only franchise owner can delete franchise")
...
define("LEAGUE_SLOTS_EMPTY", "Pending registration of total teams")
define("LEAGUE_PENDING_REGISTRATION", "Pending registration of league's total teams")
...
define("NOT_ELIGIBLE_TO_ACCEPT", "You are not eligible to accept the challenge")
...
define("ONLY_FRANCHISE_OWNER_CAN_DELETE_LEAGUE", "Only franchise owner can delete league")
define("INVALID_STARTING_DATE", "Starting date is not valid")
define("INVALID_ENDING_DATE", "Ending date is not valid")
define("LEAGUE_FOR_THIS_YEAR_ALREADY_EXIST", "League for this year is already exist")
define("SOME_LEAGUE_HAVE_PENDING_RESULT", "Some leagues have pending result or not end, Can not Delete!")
define("NOT_PARTICIPATING", "Not participating")
define("ALREADY_SELECTED", "Member already selected")
define("NOT_UPDATE_NOW", "Update not allowed now")
define("REQUIRED_TEAMS_ALREADY_REGISTERED", "No. of required total teams already registered")
...
define("SCHEDULE_TYPE_ROUND_NO_INCORRECT", "Schedule type or Round number incorrect")
...
define("CAN_NOT_PLAY_FL", "League played round, Can not start Fantasy League Now !")
...
define("LESS_THAN_REQUIRED_TEAMS", "Total teams of ladder are less than required teams")
define("CAN_NOT_JOIN_AFTER_DATE", "Can not join after start date")
define("LADDER_RESULT_NOT_FINALIZE_PENDING", "Ladder results should be finalize before Total War Ladder start")
define("CAN_NOT_CREATE_FL_LEAGUE_END", "Can not create Fantasy League after League ended")
define("CAN_NOT_SUBMIT_RESULT_BEFORE_START", "Can not submit result before start")
...
define("CAN_NOT_DELETE_PENDING_RESULT", "Can not delete! Pending results exist")
define("CAN_NOT_DELETE_SOME_PENDING_RESULT", "Can not delete! Wait for some results")
define("CAN_NOT_DELETE_TEAM_PENDING_RESULT", "Can not delete! Wait for all teams results")
define("TEAM_HAS_PENDING_INVITES", "Can not delete! Pending team invites exist")
define("SOME_RESULT_NOT_DELETE", "Some pending results can not delete!")
define("SOME_RECORDS_NOT_DELETE", "Some records can not delete (wait for FL end)")
define("NOT_JOIN_TEAM_PARTICIPATING_TOURNAMENT", "Can not join team! Team currently playing in tournament")
define("NOT_JOIN_TEAM_PARTICIPATING_LADDER", "Can not join team! Team currently playing in ladder")
define("NOT_KICK_TEAM_PARTICIPATING_TOURNAMENT", "Can not kick out from team! Team currently playing in tournament")
define("NOT_KICK_TEAM_PARTICIPATING_LADDER", "Can not kick out from team! Team currently playing in ladder")
define("NOT_KICK_TEAM_PARTICIPATING_LEAGUE", "Can not kick out from team! Team currently playing in league")